...
port="$3"
shift 3
local_dir="/home/tom/MEGA/treciasKursas/tengui/modules/chkrootkit/${remote_host}/"
...
scp "/home/tom/MEGA/treciasKursas/tengui/modules/chkrootkit/chkrootkit.tar.gz" $username@$remote_host:/home/$username
